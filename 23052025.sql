...
INSERT INTO `ventas` VALUES (1,2550,'2025-05-19'),(2,3000,'2025-05-19'),(3,6545,'2025-05-19'),(4,5648,'2025-05-19');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_BorrarVenta`(IN Valor INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_leerVenta`()
BEGIN

SELECT * FROM Ventas  WHERE VebtaID = ID;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_LeerVentas`()
BEGIN
 SELECT * FROM  Ventas;
END ;;
DELIMITER ;
...
-- Dump completed on 2025-05-23 19:52:00
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-01-15 02:39:25',NULL),('diagnostics.include_raw','OFF','2025-01-15 02:39:25',NULL),('ps_thread_trx_info.max_length','65535','2025-01-15 02:39:25',NULL),('statement_performance_analyzer.limit','100','2025-01-15 02:39:25',NULL),('statement_performance_analyzer.view',NULL,'2025-01-15 02:39:25',NULL),('statement_truncate_len','64','2025-01-15 02:39:25',NULL);
...
-- Dump completed on 2025-05-23 19:52:01
